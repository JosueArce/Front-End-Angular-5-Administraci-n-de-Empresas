...
const MENUITEMS = [
    ...
    {state: 'dimensions', name: 'Dimensions', type: 'link', icon: 'dashboard' }, 
    {state: 'permissions', name: 'Permisos', type: 'link', icon: 'dashboard' }, 
    {state: 'components', name: 'Components', type: 'link', icon: 'extension' },
